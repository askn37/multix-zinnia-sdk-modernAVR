...
### AVR DA/DB using USERT2.PF4 LED.PA7 without PULLUP_RX
make avr128db64 BOOTNAME=boot_avrdx_UART2 UART=F4 LED=A7 PULLUP_RX=1 LED_BLINK=0
...
make avr64du32 BOOTNAME=boot_avrdu_UART0 UART=A2 LED=A7 PULLUP_RX=1 LED_BLINK=0
...
### AVR_DU 14/20/28/32pin using USERT1.PD6 LED.PC3 (PC3 is LUT1_OUT) without PULLUP_RX
make avr64du32 BOOTNAME=boot_avrdu_UART1 UART=D6 LED=C3 PULLUP_RX=1 LED_BLINK=0
