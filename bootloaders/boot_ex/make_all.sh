...
### AVR_EB 14/20pin using USERT0.PA0 LED.PD7
make avr32la14 BOOTNAME=boot_avrla_UART0 UART=A0 LED=D7 PULLUP_RX=1

###
### AVR_EA/EB/LA Alternate
###
...
### AVR32LA32 32pin using USERT0.PD4 LED.PF5 (PORTMUX_USART0_ALT3)
make avr32la32 BOOTNAME=boot_avrla_UART0 UART=D4 LED=F5 PULLUP_RX=1
