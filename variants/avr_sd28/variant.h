...
#define AVR_AVRSX     1
#define AVR_AVRSD     1
#define AVR_AVRSD28   1
#define AVR_NVMCTRL   6
...
/* GPIO x23 (other VDD,GND,AVDD,GND,VDD2) */
...
/* #define PIN_TCD0_WOC_ALT1 PIN_PB4 */
/* #define PIN_TCD0_WOD_ALT1 PIN_PB5 */
...
/* #define PIN_AC0_OUT_ALT1  PIN_PC6 */
...
/* #define PIN_AC2_OUT_ALT1  PIN_PC6 */
...
#define PIN_ADC1_AIN4     PIN_PD4
#define PIN_ADC1_AIN5     PIN_PD5
#define PIN_ADC1_AIN6     PIN_PD6
#define PIN_ADC1_AIN7     PIN_PD7
#define PIN_ADC1_AIN24    PIN_PA4
#define PIN_ADC1_AIN25    PIN_PA5
#define PIN_ADC1_AIN26    PIN_PA6
#define PIN_ADC1_AIN27    PIN_PA7
...
/* #define PIN_ZCD0_OUT      PIN_PA7 */
/* #define PIN_ZCD0_OUT_ALT1 PIN_PC7 */
#define PIN_ZCD3_IN       PIN_PC2
#define PIN_ZCD3_OUT      PIN_PA7
#define PIN_ZCD3_OUT_ALT1 PIN_PC7

#define PIN_HEART         PIN_PA2
#define PIN_HEART_ALT1    PIN_PA4
#define PIN_HEART_ALT2    PIN_PA6
#define PIN_HEART_ALT3    PIN_PA7
#define PIN_HEART_ALT4    PIN_PD4
#define PIN_HEART_ALT5    PIN_PF5
...
#define HAVE_ADC0       ADC0_ERROR_vect_num
#define HAVE_ADC1       ADC1_ERROR_vect_num
#define HAVE_BOD           BOD_VLM_vect_num
#define HAVE_CCL           CCL_CCL_vect_num
#define HAVE_CLKCTRL   CLKCTRL_INT_vect_num
#define HAVE_CRCSCAN   CRCSCAN_INT_vect_num
#define HAVE_ERRCTRL   ERRCTRL_INT_vect_num
#define HAVE_MVIO        MVIO_MVIO_vect_num
#define HAVE_NMI               NMI_vect_num
#define HAVE_NVMCTRL NVMCTRL_READY_vect_num
...
#define HAVE_RAMCTRL   RAMCTRL_INT_vect_num
